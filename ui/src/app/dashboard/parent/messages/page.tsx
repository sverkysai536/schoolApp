        ...
        const fetchData = async () => {
            try {
                ...
                if (recRes.ok) {
                    ...
                    setRecipients(data);
                    if (data.length > 0) setSelectedRecipient(data[0].pk); // Default select first
                }
    ...
    return (
        <div className="p-8 max-w-4xl mx-auto">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-white drop-shadow-md">Messages</h1>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
                ...
                <Card glass className="md:col-span-1 p-4 flex flex-col gap-4 bg-black/60 border-white/10">
                    ...
                    <div>
                        ...
                        >
                            <option value="" disabled>Select a Teacher/Admin</option>
                            {recipients.map(r => (
